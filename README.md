...
================
Melanie Dickie and Mariana Nagy-Reis
16/04/2021
...
```
    ...
    ##                 Range MeanKmCreateRate MeanKmPartialRegenRate
    ## 1           Chinchaga              321                    822
    ## 2           Cold Lake             2080                   1138
    ## 3 East Side Athabasca             2234                   1270
    ## 4        Little Smoky              217                    161
    ## 5              Nipisi               93                     83
    ## 6           Red Earth              509                    639
    ## 7          Richardson              159                    142
    ## 8          Slave Lake               59                     81
    ## 9 West Side Athabasca              640                    533
    ##   MeanKmFullRegenRate MeanNetKmPartialRegenRate MeanNetKmFullRegenRate
    ## 1                 524                       502                    203
    ## 2                 104                      -942                  -1976
    ## 3                 164                      -963                  -2069
    ## 4                 104                       -57                   -113
    ...
    ## 8                  14                        23                    -44
    ## 9                 135                      -107                   -505
    ##   RangeArea MeanDensCreateRate MeanDensPartialRegenRate MeanDensFullRegenRate
    ## 1     17644                 18                       47                    30
    ## 2      6726                309                      169                    15
    ## 3     13119                170                       97                    12
    ## 4      3084                 70                       52                    34
    ...
    ## 8      1516                 39                       53                     9
    ## 9     15707                 41                       34                     9
    ##   MeanNetDensPartialRegenRate MeanNetDensFullRegenRate PercPartialRegen
    ## 1                          28                       12               80
    ## 2                        -140                     -294               48
    ## 3                         -73                     -158               36
    ## 4                         -18                      -37               89
